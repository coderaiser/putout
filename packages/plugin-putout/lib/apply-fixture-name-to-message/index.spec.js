...
test('putout: apply-fixture-name-to-message: transform-with-options', (t) => {
    t.transform('transform-with-options');
    t.end();
});

test('putout: apply-fixture-name-to-message: no-transform-with-options', (t) => {
...
test('putout: apply-fixture-name-to-message: transform: report-with-options', (t) => {
