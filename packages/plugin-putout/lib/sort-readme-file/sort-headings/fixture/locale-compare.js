__putout_processor_markdown([
    heading(2, 'Rules'),
    ul(li('✅ ', link('remove-useless-promisify', '#remove-useless-promisify'), ';'), li('✅ ', link('remove-useless-attribute', '#remove-useless-attribute'), ';')),
    ...
    heading(2, 'remove-useless-attribute'),
