__putout_processor_markdown([
    heading(2, 'Rules'),
    ul(
        li('✅ ', link('add-path-arg-to-filter', '#add-path-arg-to-filter'), ';'),
        li('✅ ', link('add-path-arg-to-match', '#add-path-arg-to-match'), ';'),
        li('✅ ', link('add-test-args', '#add-test-args'), ';'),
        li('✅ ', link('convert-get-file-content-to-read-file-content', '#convert-get-file-content-to-read-file-content'), ';'),
        li('✅ ', link('includer', '#includer'), ';'),
        li('✅ ', link('move-require-on-top-level', '#move-require-on-top-level'), ';'),
    ),
    heading(2, 'File rules'),
    ul(
        li('✅ ', link('sort-readme-file', '#sort-readme-file'), ';'),
    ),
    heading(2, 'Config'),
    codeblock('json', `
    `),
