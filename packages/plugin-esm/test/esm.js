...
test('plugin-esm: no report: resolve-imported-file-with-extension', (t) => {
    t.noReport('resolve-imported-file-with-extension');
    t.end();
});

test('plugin-esm: no report: shorten-imported-file', (t) => {
    t.noReport('shorten-imported-file');
    t.end();
});
