...
test('remove-unused-variables: get-vars: keyword', (t) => {
    const ast = parse(fixture.keyword);
    const result = getVars(ast).map(dutify);
...
test('remove-unused-variables: get-vars: export: destruturing', (t) => {
    const ast = parse(fixture.exportDestructuring);
    const result = getVars(ast);
...
test('remove-unused-variables: get-vars: ts-non-null-expression', (t) => {
    const ast = parse(fixture.tsNonNullExpression, {
        isTS,
    });
