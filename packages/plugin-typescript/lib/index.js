import * as convertEmptyTypeLiteralToRecord from './convert-empty-type-literal-to-record/index.js';
...
export const rules = {
    ...
    'convert-empty-type-literal-to-record': convertEmptyTypeLiteralToRecord,
};
