...
export default {
    ...
    'fresh:only:putout': async () => [eslintOffEnv, await cutEnv(['lint:only:putout', 'coverage'])],
    'fresh:only:eslint': async () => [putoutOffEnv, await cutEnv(['lint:only:eslint', 'coverage'])],
