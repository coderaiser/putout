...
And the reason is 🐊[`PutoutScript`](https://github.com/coderaiser/putout/tree/master/packages/compare#readme) `JavaScript`-compatible language which adds additional meaning to identifiers used in `AST`-template.
